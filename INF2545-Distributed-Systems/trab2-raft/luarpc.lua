...
function luarpc.process_request(client, request_msg, servant)
  ...
  local implFunc = servants_lst[servant]["obj"][func_name] -- mpaulon: resultParams = {pcall(impl[data.method],table.unpack(params))}
  local result = table.pack(pcall(implFunc, table.unpack(params))) -- mpaulon
  -- print(result) -- mpaulon 
