...
public class Assets {
	...
	public static BufferedImage start, wall, hole, powerup, powerupvisited, floor, floorvisited, teletransport, teletransport2, teletransport3, gold;
	...
	public static void init() {
		...
		powerupvisited = sheet.crop(TILE_WIDTH * 4, TILE_HEIGHT * 2, TILE_WIDTH, TILE_HEIGHT);
