...
public class ImageSheet
{
	 ...
	 * <p>
	 * <b>ImageSheet:</b> Creates a image sheet object.
	 * </p>
	 * 
	 * @param sheet
	 *            Sheet image
	 ...
	 * 
	 * @param x
	 *            Horizontal coordinate where the sub-image (tile) starts
	 * @param y
	 *            Vertical coordinate where the sub-image (tile) starts
	 * @param width
	 *            The sub-image's width (tile)
	 * @param height
	 *            The sub-image's height (tile)
