...
public class LaneView extends View {
	...
	private void renderGreenLane(Graphics2D g2d)
	{
		for(int i = 1; i <= 5; i++)
		{
			...
			new SquareView(greenLane.getSquareAt(i), (int) coordinate.getX(), (int) coordinate.getY(), GameColor.Green, highlight).render(g2d);
		}
	}
	...
	private void renderYellowLane(Graphics2D g2d)
	{
		for(int i = 1; i <= 5; i++)
		{
			...
			new SquareView(yellowLane.getSquareAt(i), (int) coordinate.getX(), (int) coordinate.getY(), GameColor.Yellow, highlight).render(g2d);
		}
	}
	...
	private void renderBlueLane(Graphics2D g2d)
	{
		for(int i = 1; i <= 5; i++)
		{
			...
			new SquareView(blueLane.getSquareAt(i), (int) coordinate.getX(), (int) coordinate.getY(), GameColor.Blue, highlight).render(g2d);
		}
	}
	...
	private void renderRedLane(Graphics2D g2d)
	{
		for(int i = 1; i <= 5; i++)
		{
			...
			new SquareView(redLane.getSquareAt(i), (int) coordinate.getX(), (int) coordinate.getY(), GameColor.Red, highlight).render(g2d);
		}
	}
