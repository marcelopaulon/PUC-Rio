...
const char DETURPAR_CMD					  [ ] = "=deturparlista" ;
...
*     =irinicio                     inxLista
*     =irfinal                      inxLista
*     =avancarelem                  inxLista  NumeroDeElementos CondRetEsp
*
...
*                   - Chama a função LiberarTudo( ), que libera todos os espaços alocados dinamicamente
*
***********************************************************************/
   ...
   TST_tpCondRet TST_EfetuarComando(char * ComandoTeste)
   {
      ...
      /* LIS  &Avançar elemento */
         ...
         else if (strcmp(ComandoTeste , AVANCAR_ELEM_CMD) == 0)
         {
            ...
            numLidos = LER_LerParametros("iii" , &inxLista , &NumeroDeElementos ,
                                &CondRetEsp) ;
            ...
            return TST_CompararInt(CondRetEsp ,
                      LIS_AvancarElementoCorrente(vtListas[ inxLista ] , NumeroDeElementos) ,
		  ...
		  /* Deturpar uma árvore */
			 ...
			 else if (strcmp(ComandoTeste , DETURPAR_CMD) == 0)
			 {
				...
				LIS_DeturparLista(vtListas[ inxLista ] , IntEsperado) ;
		  ...
		  /* Verificar vazamento de memória */
			 ...
			 /* Tratar: TLIS Liberar Tudo */
		  #ifdef _DEBUG

			 else if ( strcmp( ComandoTeste , LIBERAR_TUDO_CMD ) == 0 )
			 {
				  int i ;
      
				  int total = CED_ObterNumeroEspacosAlocados( ) ;
				  ...
				  for ( i = 0 ; i < total ; i++ )
				  {
					 ...
					 /* O CED_ExcluirEspacoCorrente já atualiza o ponteiro para o próximo espaço */
				  } /* for */
